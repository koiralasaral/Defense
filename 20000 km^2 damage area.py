...
for target_rocket in rockets:
    ...
    for other_rocket in rockets:
        if other_rocket != target_rocket:
            ...
            if other_a_coeff != 0 and b_coeff != 0 and c_coeff != 0:
            ...
            elif other_a_coeff == 0 and b_coeff != 0 and c_coeff != 0:
                print(f"    {other_rocket}: a is 0, b is {b_coeff/other_b_coeff:.2f} times its b.  c is {c_coeff/other_c_coeff:.2f} times its c")
            elif other_a_coeff != 0 and b_coeff == 0 and c_coeff != 0:
                print(f"    {other_rocket}: a is {a_coeff/other_a_coeff:.2f} times its a, b is 0.  c is {c_coeff/other_c_coeff:.2f} times its c")
            elif other_a_coeff != 0 and b_coeff != 0 and c_coeff == 0:
                print(f"    {other_rocket}: a is {a_coeff/other_a_coeff:.2f} times its a, b is {b_coeff/other_b_coeff:.2f} times its b.  c is 0")
            elif other_a_coeff == 0 and b_coeff == 0 and c_coeff != 0:
                print(f"    {other_rocket}: a is 0, b is 0. c is {c_coeff/other_c_coeff:.2f} times its c")
            elif other_a_coeff == 0 and b_coeff != 0 and c_coeff == 0:
                print(f"    {other_rocket}: a is 0, b is {b_coeff/other_b_coeff:.2f} times its b. c is 0")
            elif other_a_coeff != 0 and b_coeff == 0 and c_coeff == 0:
                print(f"    {other_rocket}: a is {a_coeff/other_a_coeff:.2f} times its a, b is 0. c is 0")
            elif other_a_coeff == 0 and b_coeff == 0 and c_coeff == 0:
                print(f"    {other_rocket}: a is 0, b is 0. c is 0")
