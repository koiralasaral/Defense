...
# Plot the blast area for the new missile
plot_3d_blast_area(new_rocket_data[new_missile_name]["energy_joules"], title=f"Blast Area of {new_missile_name}")
# Plot the blast area for the closest rocket
plot_3d_blast_area(rocket_data[closest_rocket]["energy_joules"], title=f"Blast Area of {closest_rocket}")
# Plot the blast area for the V2 rocket
plot_3d_blast_area(rocket_data['V2']['energy_joules'], title="Blast Area of V2 Rocket")
# Plot the blast area for the Iskander rocket
plot_3d_blast_area(rocket_data['Iskander']['energy_joules'], title="Blast Area of Iskander Rocket")
# Plot the blast area for the Minuteman III rocket
plot_3d_blast_area(rocket_data['Minuteman_III']['energy_joules'], title="Blast Area of Minuteman III Rocket")
# Plot the blast area for the Topol M rocket
plot_3d_blast_area(rocket_data['Topol_M']['energy_joules'], title="Blast Area of Topol M Rocket")